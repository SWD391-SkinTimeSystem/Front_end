...
//         id: "opt1",
//         skin_type: { nameSkinType: "Da khô" },
//       },
//       {
//         content: "Bình thường, thoải mái",
//         id: "opt2",
//         skin_type: { nameSkinType: "Da thường" },
//       },
//       {
//         content: "Dầu ở vùng chữ T, bình thường ở má",
//         id: "opt3",
//         skin_type: { nameSkinType: "Da hỗn hợp" },
//       },
//       {
//         content: "Rất dầu trên toàn bộ khuôn mặt",
//         id: "opt4",
//         skin_type: { nameSkinType: "Da dầu" },
//       },
//     ],
//     idQuestion: "q1",
//   },
...
//         id: "opt4",
//         skin_type: { nameSkinType: "Da nhạy cảm" },
//       },
//     ],
//     idQuestion: "q2",
//   },
...
const QuizManagement: React.FC = () => {
  ...
  const [newQuestion, setNewQuestion] = useState<Question>({
    ...
    content: "",
    questionOptions: [
      { content: "", id: "", skin_type: { nameSkinType: "" } },
    ],
    idQuestion: "",
  });

  const { question, loading, error, fetchQuestions, doQuestion } = useQuestion();
    ...
    try {
      const updatedQuestions = questions.map((question, index) => {
        return {
          ...
          order_no: question.no,
          choices: question.questionOptions.map((option) => {
            return {
              id: option.id,
              content: option.content,
              skin_type: option.skin_type,
            };
          }),
        };
      });

      await questionService.updateQuestion(updatedQuestions);
      // Renumber questions
      // const updatedQuestions = QuestionUpdate[];
  ...
  const handleNewOptionSkinTypeChange = (index: number, skinType: string) => {
    ...
    options[index] = {
      ...options[index],
      skin_type: { nameSkinType: skinType }, // Gán trực tiếp một loại da mới
    };
                              ...
                              <div className="flex flex-wrap gap-2">
                                {availableSkinTypes.map((skinType) => (
                                  <Button
                                    ...
                                    size="sm"
                                    variant={
                                      option.skin_type.nameSkinType === skinType // So sánh với nameSkinType
                                        ? "default"
                                        : "outline"
                                    }
                                    className={
                      ...
                      <Button
                        ...
                        disabled={
                          ...
                          newQuestion.questionOptions.some(
                            (opt) => !opt.content || !opt.skin_type.nameSkinType
                          )
                        }
                      >
                        Lưu
                        ...
                        {question.questionOptions.map((option) => (
                          ...
                          >
                            ...
                            <div className="mt-1">
                              ...
                              {option.skin_type && option.skin_type.nameSkinType ? (
  <span className="px-2 py-1 bg-[#e6f0eb] text-[#326e51] rounded text-xs">
    {option.skin_type.nameSkinType}
  </span>
) : (
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {availableSkinTypes.map((skinType) => (
                                    <Button
                                      ...
                                      type="button"
                                      size="sm"
                                      variant={option.skin_type && option.skin_type.nameSkinType === skinType ? "default" : "outline"}

                                      className={option.skin_type && option.skin_type.nameSkinType === skinType ? "h-7 text-xs bg-[#326e51] hover:bg-[#275941]" : "h-7 text-xs"}
                    ...
                    <Button
                      ...
                      disabled={
                        ...
                        editingQuestion.questionOptions.some(
                          (opt) => !opt.content || !opt.skin_type || !opt.skin_type.nameSkinType
                        )
                      }
                    >
                      Lưu thay đổi
