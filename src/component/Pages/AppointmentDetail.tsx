...
<h2 className="text-2xl font-semibold mb-4 pl-4 border-l-4 border-indigo-500 text-gray-800">
  Chi tiết lịch hẹn
    ...
    <div className="mt-4 border-t pt-4">
      ...
      >
        <div className="mt-2 p-4 bg-gray-100 rounded-lg shadow-inner">
          ...
          <p className="flex justify-between text-red-500 font-bold border-t pt-2 mt-2">
