      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="detail">
          <div id="ServiceDescription">
            <div className="max-w-4xl mx-auto p-6">
              ...
              <div className="mt-4 space-y-2 text-black">
                <p>
                  <span className="font-semibold">Hiệu quả:</span> {selectedService?.description || "Không có thông tin"}
                </p>
                <p>
          ...
          <div>
            ...
            {Array.isArray(serviceDetail?.serviceDetails) && serviceDetail.serviceDetails.map((serviceDetail, index) => (
              ...
              <div key={serviceDetail.id}>
                <Card className="w-full rounded-none mt-5 border-none shadow-none">
                  <CardContent className="flex flex-row items-center">
                    ...
                    <div className="w-1/2">
                      <h2 className="text-lg font-semibold text-gray-900">
                        Ngày {serviceDetail.step} : {serviceDetail.name}
                      </h2>
                      <p className="text-sm text-gray-600 mt-2 mb-1">
