...
export default function BookingTable() {
  ...
  const filteredBookings = bookings.filter((booking) => {
    ...
    const matchesDate = filterDate === "All" || formatEventDate(booking.bookingDate) === filterDate;
      ...
      <div className="flex gap-4 mb-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            {bookings.map((b) => (
              <DropdownMenuItem key={formatEventDate(b.bookingDate)} onClick={() => setFilterDate(formatEventDate(b.bookingDate))}>
                {formatEventDate(b.bookingDate)}
              </DropdownMenuItem>
            ))}
          </DropdownMenuContent>
        </DropdownMenu>
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-emerald-100">
            ...
            <TableHead className="text-emerald-700 font-semibold">Khách hàng</TableHead>
            <TableHead className="text-emerald-700 font-semibold">Thời gian Đặt</TableHead>
          ...
          {filteredBookings.length > 0 ? (
            filteredBookings.map((booking, index) => (
              ...
              >
                ...
                <TableCell>{formatEventDate(booking.bookingDate)}</TableCell>
